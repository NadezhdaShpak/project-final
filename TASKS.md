...
в папке bugtracking в подпапках находяттся наборы модель, сервис, репозиторий, маппер и ТО, контроллер
common классы ошибок, конфиги
   login - авторизация
...
3. Вынести чувствительную информацию в отдельный проперти файл:</br>
   логин</br>
   пароль БД </br>
   идентификаторы для OAuth регистрации/авторизации</br>
   настройки почты</br>
